...
This is the public issue and release space for [Blockchain Foundry's](http://blockchainfoundry.co) Blockmarket product. Blockmarket's source code is proprietary but this repository serves as a location for public beta releases, issue tracking, and eventually and releases for Blockmarket Desktop binaries.
...
**Blockmarket Desktop Status**: *1.0.0* | [Download 1.0.0](https://github.com/syscoin/blockmarket-desktop-public/releases/tag/1.0.0)
